...
function SignUp() {
    ...
    const onChange = (e) => {
      setFormData((prevState) => ({
        ...prevState,
        [e.target.id]: e.target.value, //change the value based
      }))
    ...
    const onSubmit = async(e) =>{
      ...
      try {
        ...
        delete formDataCopy.password //objeden çıkardık istemiyoruz password kaydetmeyi
           ...
           <main>
             <form onSubmit={onSubmit} >
               ...
               <div className="passwordInputDiv">
                 ...
                 <img src={visibilityIcon} alt="show pasword" 
